            ...
            <div className="flex-1 bg-[#FFF9F1] p-12 md:p-16 flex flex-col justify-center text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="text-right -mt-2 mb-8">
                  <button type="button" className="inline text-[0.8rem] text-[#5D5447] border-b border-[#5D5447]/30 bg-transparent">忘記密碼？</button>
                </div>
              ...
              <div className="mt-10 bg-white rounded-full py-4 px-8 flex items-center justify-center gap-5 shadow-sm">
                ...
                <button type="button" className="border border-gray-300 px-6 py-1.5 rounded-full text-[0.85rem] font-bold hover:bg-primary hover:text-white hover:border-primary transition-all whitespace-nowrap bg-transparent">
                  手刀加入
                </button>
              </div>
            </div>
